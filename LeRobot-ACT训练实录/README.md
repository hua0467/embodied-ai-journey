...
- [4090 上的第一次训练：8 个坑，没有一个是算法问题](4090上的第一次训练-8个坑没有一个是算法问题.md)——第一人称叙事主线：为什么做、踩坑现场、训练结果解读、今日教训清单、汽车-机器人对照表
...
2. 对齐数据维度：真机数据目前缺夹爪维度，补齐后跑归一化统计（格式合同见 [openpi 数据格式笔记](../02-VLA数据管线-从遥操到真机/给机器人基础模型准备教材-openpi数据格式学习笔记.md)）
