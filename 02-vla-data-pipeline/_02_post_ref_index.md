...
> 本目录全部文件为实习期间原始记录，代表当时的技术认知，**没有商业视角**。
> 本文件是后期新增的外部索引——只做链接，不改动任何原文。

自 2026.8.26 ARE 展会（深圳国际工业自动化及机器人展）起，我开始回看这些工程实践，逐步积累产业与商业层面思考（实习期间及结束后持续），跳转查阅：

- IK 求解器 v1→v2 重构记录 → [复盘：数据管线的壁垒与边界](../03-post_intern_iterate/03_data_infra_border_and_barrier.md)
...
>
> 🚧 状态：以上目标文件目前为骨架（目录与提纲），正文自 2026.8.26 ARE 展会起开始填充迭代。
